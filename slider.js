...
$(function () {
    var output = document.querySelectorAll('output.target')[0];
    var target = "target";

    
    $(document).on('input.target', 'input.target[type="range"]', function (e) {
...
$(function () {
    var output = document.querySelectorAll('output.setSet')[0];
    var set = "set";

    
    $(document).on('input.setSet', 'input.setSet[type="range"]', function (e) {
        output.innerHTML = Math.ceil(e.currentTarget.value);
        localStorage.setItem(set, output.innerHTML);
    });
